...
<Dialog.Root bind:open={termsOpen}>
	...
	<Dialog.Content class="sm:max-w-[720px]">
		...
		<div class="text-muted-foreground max-h-[60vh] space-y-4 overflow-y-auto pr-2 text-sm">
			<p><b>1. Introduction.</b> These Terms govern your use of the TRXD platform and services.</p>
			<p>
				<b>2. Eligibility.</b> You must comply with applicable laws and be authorized to use this service.
			</p>
			<p>
				<b>3. Account.</b> You’re responsible for maintaining the confidentiality of your credentials.
			</p>
			<p>
				<b>4. Acceptable Use.</b> No abuse, unauthorized access attempts, or harmful activities.
			</p>
			<p>
				<b>5. Content.</b> You’re responsible for the content you submit. Do not upload unlawful content.
			</p>
			...
			<p>
				<b>9. Limitation of Liability.</b> To the maximum extent permitted by law, our liability is limited.
			</p>
