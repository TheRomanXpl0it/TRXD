...
const team = {
  ...
  solves: [
    { id: 1, name: 'A', category: 'Web', points: 100, user_id: 11, timestamp: '2024-01-02T00:00:00Z' },
    { id: 2, name: 'B', category: 'Crypto', points: 200, user_id: 10, timestamp: '2024-01-01T00:00:00Z' }
  ]
};
